...
Die Experimente nutzen den CLAMM ICDAR-2017-Datensatz mit 3,540 Trainings- und 2,000 Testbildern aus dem 5.-16. Jahrhundert. Der Datensatz umfasst 15 Datumsklassen für spezifische Zeitintervalle. Die Aufteilung erfolgt chronologisch: Training auf Dokumenten vor 1400, Test auf Dokumenten nach 1400.

\subsection{Experimentelles Setup}

\textbf{Feature-Extraktion:} AttMask-Features von Raven et al. werden als vortrainierte Repräsentationen verwendet. Die Features sind bereits für Writer Retrieval optimiert.
