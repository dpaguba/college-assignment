...
\bibitem{clerice2024}
Cl{\'e}rice, T., Pinche, A., Vlachou-Efstathiou, M., Chagu{\'e}, A., Camps, J.-B., et al. (2024).
\newblock CATMuS Medieval: A multilingual large-scale cross-century dataset in Latin script for handwritten text recognition and beyond.
\newblock In \textit{International Conference on Document Analysis and Recognition (ICDAR)}, Athens, Greece.
